document.addEventListener("DOMContentLoaded", function() {
    ...
    if (btnTogglePassword && inputPassword && iconoOjo) {
        btnTogglePassword.addEventListener('click', function () {
            ...
            iconoOjo.innerHTML = isPassword ? ojoCerrado : ojoAbierto;
        });
    }
});
